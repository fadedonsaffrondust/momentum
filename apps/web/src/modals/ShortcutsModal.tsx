...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    description: 'On the /team page, grouped by assignee.',
    rows: [
      { keys: ['j'], label: 'Next task in column' },
      { keys: ['k'], label: 'Previous task in column' },
      { keys: ['h'], label: 'Left column' },
      { keys: ['l'], label: 'Right column' },
      { keys: [']'], label: 'Next teammate section' },
      { keys: ['['], label: 'Previous teammate section' },
      { keys: ['f'], label: 'Cycle date scope (Today → Week → All)' },
      { keys: ['e'], label: 'Edit task title inline' },
      { keys: ['A'], label: 'Reassign selected task' },
      { keys: ['Enter'], label: 'Open task detail modal' },
