...
const SECTIONS: Section[] = [
  ...
  {
    title: 'Jarvis',
    description: 'On the /jarvis page (and inside a conversation).',
    rows: [
      { keys: ['g', 'j'], label: 'Go to Jarvis' },
      { keys: ['n'], label: 'New conversation' },
      { keys: ['/'], label: 'Focus the composer' },
      { keys: ['j'], label: 'Next conversation in the list' },
      { keys: ['k'], label: 'Previous conversation in the list' },
      { keys: ['Enter'], label: 'Send message (inside the composer)' },
      { keys: ['⇧', 'Enter'], label: 'Newline in the composer' },
      { keys: ['⌘', 'Enter'], label: 'Send message (alternate)' },
      { keys: ['Esc'], label: 'Blur the composer' },
    ],
  },
];
