...
const BADGE_COLORS = [
  '#4F8EF7', '#F7B24F', '#4FD1C5', '#F76C6C',
  '#B184F7', '#6BCB77', '#F78FB3', '#FFD93D',
];
...
export function StakeholderBadge({ stakeholder, index, lastMentionDate, onClick }: Props) {
  ...
  return (
    <button
      onClick={onClick}
      title={tooltip}
      className="group relative flex items-center justify-center w-8 h-8 rounded-full text-[10px] font-semibold transition hover:ring-2 hover:ring-offset-1 hover:ring-offset-zinc-950"
      style={{
